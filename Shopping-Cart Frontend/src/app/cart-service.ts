...
export class CartService {
    ...
    private cartAddUrl = 'http://localhost:8080/cart/rest/product/saveToCart'; // Add product URL
    private cartUrl = 'http://localhost:8080/cart/rest/product/getAllCart'; // Add product URL
