...
var CartService = (function () {
    function CartService(http) {
        this.http = http;
        this.cartAddUrl = 'http://localhost:8080/cart/rest/product/saveToCart'; // Add product URL
        this.cartUrl = 'http://localhost:8080/cart/rest/product/getAllCart'; // Add product URL
