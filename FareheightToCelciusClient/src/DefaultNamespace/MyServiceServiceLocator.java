...
public class MyServiceServiceLocator extends org.apache.axis.client.Service implements DefaultNamespace.MyServiceService {
    ...
    private java.lang.String MyService_address = "http://localhost:8080/FareheightToCelcius/services/MyService";
    ...
    public DefaultNamespace.MyService getMyService() throws javax.xml.rpc.ServiceException {
    ...
    public DefaultNamespace.MyService getMyService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            DefaultNamespace.MyServiceSoapBindingStub _stub = new DefaultNamespace.MyServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (DefaultNamespace.MyService.class.isAssignableFrom(serviceEndpointInterface)) {
                DefaultNamespace.MyServiceSoapBindingStub _stub = new DefaultNamespace.MyServiceSoapBindingStub(new java.net.URL(MyService_address), this);
                _stub.setPortName(getMyServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://DefaultNamespace", "MyServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://DefaultNamespace", "MyService"));
        }
